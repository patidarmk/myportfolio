...
import curdPreview from "../assets/curd_MERN.PNG";
      ...
      <div className="grid">
        <div className="project">
          <div className="project-img">
            <img src={spotifyPreview} alt="project-cover" />
          </div>
          <div className="project-details">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              href="https://patidarmk-spotify.netlify.app/"
            >
              Spotify Clone App
            </a>
            ...
            <div className="project-head">
              <div className="icon-container">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/patidarmk/spotify"
                >
                  <svg
        ...
        <div className="project">
            ...
            <div className="project-head">
              <div className="icon-container">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/patidarmk/harry-potter-react-app"
                >
                  <svg
                    className="icon-secondary"
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="project-img">
            <img src={harryPotterPreview} alt="project cover4" />
          </div>
        </div>
		...
		<div className="project">
          <div className="project-img">
            <img src={curdPreview} alt="project-cover" />
          </div>
          <div className="project-details">
            <span className="project-feature-tag">Feature Project</span>
            <a
            ...
            <div className="project-description">
					It demonstrates my skills in frontend development with React.js, state management with Redux, server-side development with Node.js and Express.js, and database management with MongoDB.</div>
            <div className="project-skills">
              <span>React JS</span>
              <span>Redux</span>
			  <span>Node.js</span>
            ...
            <div className="project-head">
              <div className="icon-container">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/patidarmk/upforceTech_task_curd"
                >
                  <svg
                    className="icon-secondary"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://upforcetech-task.netlify.app/"
                >
                  {" "}
                  <svg
                    className="icon-secondary"
        ...
        <div className="project">
          <div className="project-img">
            <img src={curdPreview} alt="project cover 3" />
          </div>
          <div className="project-details">
             <span className="project-feature-tag">Feature Project</span>
            <a
